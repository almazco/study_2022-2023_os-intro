...
Откроем терминал и создадим в домашнем каталоге папку backup. После чего создадим файл lab10_1.sh для написания скрипта. 

Скрпит будет делать резервную копию самого себя (то есть файла, в котором содержится его исходный код) в другую директорию backup
в домашнем каталоге. При этом файл должен архивироваться одним из архиваторов на выбор zip, bzip2 или tar. 

![Написание первого скрипта](image/1.PNG){ #fig:002 width=100% }
...
![Написание второго скрипта](image/4.PNG){ #fig:005 width=100% }
...
![Написание третьего скрипта](image/5.PNG){ #fig:008 width=100% }
...
![Написание четвёртого скрипта](image/6.PNG){ #fig:011 width=100% }
